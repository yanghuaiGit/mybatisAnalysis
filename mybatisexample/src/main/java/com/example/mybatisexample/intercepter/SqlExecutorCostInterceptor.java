package com.example.mybatisexample.intercepter;
...
@Slf4j
public class SqlExecutorCostInterceptor implements Interceptor {
    public static final String TIME_LIMIT_KEY= "timelimit";
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        Executor statementHandler = (Executor) target;
        statementHandler.clearLocalCache();
        try {
    ...
    public void setProperties(Properties properties) {
        this.timeLimit = Long.valueOf(properties.getProperty(TIME_LIMIT_KEY, DEFAULT_TIME_LIMIT));
    }
